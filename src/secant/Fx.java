...
public class Fx {
	...
	public String setRoot(double FA,double FB,double FC,int noI)
	{
		...
		// method take string double num ( A or B ,c from user )
	...
	public void secant(String eq)
	{
		...
		//print  table header 
		System.out.printf(" %-3s%-12s%-12s%-12s%-12s%-12s%-12s%-12s%-12s\n","i","A","B","C","F(a)","F(b)","F(c)","cond1","cond2");
			...
			{			
				...
				System.out.printf(" %-3d%-12.4f%-12.4f%-12.4f%-12.4f%-12.4f%-12.4f%-12b%-12b\n",getN(),getA(),getB(),getc(),getFa(),getFb(),getFc(),checkCond1(getFc()),checkCond2(getnOfI()));
